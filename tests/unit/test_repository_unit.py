...
class RepositoryUnitTests(unittest.TestCase):
    ...
    def test_public_website_presents_deal_suite(self) -> None:
        ...
        self.assertIn("app.js?v=20260607-header-overlap-v1", index_html)
        self.assertIn("styles.css?v=20260607-header-overlap-v1", index_html)
    ...
    def test_public_website_supports_all_official_eu_languages(self) -> None:
        ...
        for language in languages:
            ...
            self.assertIn("styles.css?v=20260607-header-overlap-v1", html)
            self.assertIn("app.js?v=20260607-header-overlap-v1", html)
